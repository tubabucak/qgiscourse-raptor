...
/***************************************************************************
 NewRaptor
                                 A QGIS plugin
 Add a new raportor nest, create a buffer, and impact table
 Generated by Plugin Builder: http://g-sherman.github.io/Qgis-Plugin-Builder/
                              -------------------
        begin                : 2023-01-18
        git sha              : $Format:%H$
        copyright            : (C) 2023 by Tuba Bucak
        email                : tubabucak@gmail.com
 ***************************************************************************/
...
class NewRaptor:
    ...
    def run(self):
        ...
        # show the dialog
        self.dlg.show()
        self.dlg.cmbSpecies.currentTextChanged.connect(self.evt_cnbSpecies_changed)
        ...
        if result:
            ...
            # Find linear projects that will be impacted and report them into the table
    ...
    def evt_cnbSpecies_changed(self, species):
